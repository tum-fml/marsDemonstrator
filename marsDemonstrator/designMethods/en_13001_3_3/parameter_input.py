...
class StandardInput():
    ...
    def get_material_geometry_error_runs(self, error_configs, wheel_field, rail_field):
    ...
    def create_value_check_data(self, materials_all, geometries_all):
    ...
    def parse_check_data(self, materials_all, geometries_all):
...
class RailWheelInput():
    ...
    def copy_parameters_to_gen_params(self, target_parameters, gen_params, property_names):
